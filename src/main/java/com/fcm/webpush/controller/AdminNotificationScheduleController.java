...
public class AdminNotificationScheduleController {
	...
	@PostMapping
	public ResponseEntity<NotificationScheduleResponseDto> createSchedule(@Valid @RequestBody final NotificationScheduleRequestDto request) {
	...
	@GetMapping
	public ResponseEntity<List<NotificationScheduleResponseDto>> getAllSchedules() {
		adminService.verifyAdminAuthorization();
	...
	@GetMapping("/{id}")
	public ResponseEntity<NotificationScheduleResponseDto> getScheduleById(@PathVariable final Long id) {
		adminService.verifyAdminAuthorization();
	...
	@PutMapping("/{id}")
	public ResponseEntity<NotificationScheduleResponseDto> updateSchedule(@PathVariable final Long id, @Valid @RequestBody final NotificationScheduleRequestDto request) {
		adminService.verifyAdminAuthorization();
	...
	public ResponseEntity<NotificationScheduleResponseDto> updateScheduleStatus(@PathVariable final Long id, @RequestParam final boolean active) {
		adminService.verifyAdminAuthorization();
